...
| <a id="graphql_document_library-deps"></a>deps |  Document dependencies of this target.<br><br>This may include other graphql_document_library targets or other targets that provide GraphqlDocumentInfo. Typically these are fragment libraries which documents in "srcs" `#import`.<br><br>The transitive sources and schema of targets in the `deps` attribute are added to the runfiles of this target.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
